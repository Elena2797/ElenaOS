...
// Mismo patrón que hoto.js (D13): el formulario "actual" es el que corresponde
// al avión operativo actual (vj_state.aircraft) — nunca el de otro avión,
// aunque sea el más reciente. Ambiguo (>1 active para la misma matrícula) se
// reporta en vez de adivinar, igual que HOTO.
//
// SIN matrícula devuelve null (D34): sin avión actual no hay formulario actual.
