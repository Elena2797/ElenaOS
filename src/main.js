...
import {
  HOTO_SECTIONS as VJ_HOTO_SECTIONS,
  CABIN_CARE_LABELS as VJ_CABIN_CARE_LABELS,
  SHOPPING_ITEMS as VJ_SHOPPING_ITEMS,
  MAG_STATUS,
} from './hoto/model.js';
...
// MAG_STATUS se importa desde src/hoto/model.js (fuente única).
