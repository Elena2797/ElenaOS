...
Creación completa del sistema `/docs` como memoria persistente de LIFEOS: 29 documentos (11 raíz + 6 `core/` + 11 `modules/` + 5 `operations/`... ver estructura exacta en `README.md`), basados en auditoría directa del código, migraciones y Supabase — no en asunción.
...
Para cualquier sesión nueva: `docs/README.md` primero, siempre. Después, según la tarea, el documento específico que indica la tabla de ese mismo README.
