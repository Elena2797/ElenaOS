...
| Lo que Isabel hace sola de noche (turno de noche) | `DECISIONS.md` D65 → `operations/TURNO_NOCHE.md` |
| El buscador de Isabel (internet) | `DECISIONS.md` D67 → `isabel-api/src/core/web/research.js` |
